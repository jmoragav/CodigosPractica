...
$date=str_replace("_", " ", $_REQUEST['date']);



$date_fin=str_replace("_", " ", $_REQUEST['date_fin']);
...
$stmt = mssql_init('[dbo].[pkg_Registro.Excel_fecha]');

mssql_bind($stmt, '@FechaInit',   $date,   SQLVARCHAR  ,false,false,50);
mssql_bind($stmt, '@FechaFinal',   $date_fin,   SQLVARCHAR  ,false,false,50);
...
header('Content-Disposition: attachment;filename="Datos_fecha.xls"');
