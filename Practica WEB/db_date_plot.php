...
$stmt = mssql_init('[dbo].[pkg_Registro.SelCantidad]');
...
$date_fin=str_replace("_", " ", $_GET['date_fin']);
...
mssql_bind($stmt, '@Limit',   $limit,   SQLINT1 ,false,false,3);
mssql_bind($stmt, '@Hora',   $date,   SQLVARCHAR  ,false,false,50);
mssql_bind($stmt, '@HoraFin',   $date_fin,   SQLVARCHAR  ,false,false,50);
